 ...
 if(isset($_POST["add_to_cart"]))
 {
      if(isset($_SESSION["shopping_cart"]))
      {
           ...
           else
           {
                ...
                echo '<script>window.location="kfc.php"</script>';
           }
      }
      else
      {
      ...
      <body>
        <a href="../altindex.php">Go back to index page</a>
           ...
           <div class="container" style="width:700px;">
                ...
                ?>
                <div class="col-md-4">
                     <form method="post" action="kfc.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                <div class="table-responsive">
                     <table class="table table-bordered">
                          ...
                          <tr>
                               ...
                               <td><a href="kfc.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                          </tr>
                          <?php
