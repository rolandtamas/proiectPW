...
$connect = mysqli_connect("localhost", "root", "", "restaurants");
 if(isset($_POST["add_to_cart"]))
 {
      if(isset($_SESSION["shopping_cart"]))
      {
           ...
           else
           {
                ...
                echo '<script>window.location="mcdonalds.php"</script>';
           }
      }
      else
      {
 ...
 <html>
      <head>
          <title>Order from McDonalds</title>
      ...
      <body>
           ...
           <div class="container" style="width:700px;">
                <h3 align="center">McDonalds</h3><br />
                <?php
                $query = "SELECT * FROM mcdonalds ORDER BY id ASC";
                ...
                ?>
                <div class="col-md-4">
                     <form method="post" action="mcdonalds.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                <div class="table-responsive">
                     <table class="table table-bordered">
                          ...
                          <tr>
                               ...
                               <td><a href="mcdonalds.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                          </tr>
                          <?php
