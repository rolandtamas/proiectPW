...
$connect = mysqli_connect("localhost", "root", "", "restaurants");
 if(isset($_POST["add_to_cart"]))
 {
      if(isset($_SESSION["shopping_cart"]))
      {
           ...
           else
           {
                ...
                echo '<script>window.location="mesopotamia.php"</script>';
           }
      }
      else
      {
 ...
 <html>
      <head>
          <title>Order from mesopotamia</title>
      ...
      <body>
           ...
           <div class="container" style="width:700px;">
                <h3 align="center">mesopotamia</h3><br />
                <?php
                $query = "SELECT * FROM mesopotamia ORDER BY id ASC";
                ...
                ?>
                <div class="col-md-4">
                     <form method="post" action="mesopotamia.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                <div class="table-responsive">
                     <table class="table table-bordered">
                          ...
                          <tr>
                               ...
                               <td><a href="mesopotamia.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                          </tr>
                          <?php
